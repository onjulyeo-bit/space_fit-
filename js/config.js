...
const CONFIG = {
  ...
  QUESTIONS: [
    /* ---------- Q1 (이미지) 거실 ---------- */
    {
      ...
      title: "가장 살고 싶은 거실은?",
      options: [
        { id: "Q1-MOD", label: "모던 거실",      image: "assets/images/q1-mod.jpg", scores: { MOD: 3, MIN: 1, NAT: 0, SCA: 0, CLA: 0, MCL: 1 } },
        { id: "Q1-MIN", label: "미니멀·호텔 거실", image: "assets/images/q1-min.jpg", scores: { MOD: 1, MIN: 3, NAT: 0, SCA: 0, CLA: 0, MCL: 1 } },
        { id: "Q1-NAT", label: "내추럴 거실",     image: "assets/images/q1-nat.jpg", scores: { MOD: 0, MIN: 0, NAT: 3, SCA: 1, CLA: 0, MCL: 0 } },
        { id: "Q1-SCA", label: "북유럽 거실",     image: "assets/images/q1-sca.jpg", scores: { MOD: 0, MIN: 0, NAT: 1, SCA: 3, CLA: 0, MCL: 0 } },
        { id: "Q1-CLA", label: "클래식 거실",     image: "assets/images/q1-cla.jpg", scores: { MOD: 0, MIN: 0, NAT: 0, SCA: 0, CLA: 3, MCL: 1 } },
        { id: "Q1-MCL", label: "모던클래식 거실",  image: "assets/images/q1-mcl.jpg", scores: { MOD: 1, MIN: 1, NAT: 0, SCA: 0, CLA: 1, MCL: 3 } },
      ],
    },
    ...
    /* ---------- Q2 (이미지) 색감 ---------- */
    {
      ...
      title: "끌리는 색감은?",
      options: [
        { id: "Q2-1", label: "무채색·그레이",   image: "assets/images/q2-gray.jpg",     scores: { MOD: 3, MIN: 1, NAT: 0, SCA: 0, CLA: 0, MCL: 1 } },
        { id: "Q2-2", label: "아이보리·베이지", image: "assets/images/q2-ivory.jpg",    scores: { MOD: 1, MIN: 3, NAT: 1, SCA: 1, CLA: 0, MCL: 1 } },
        { id: "Q2-3", label: "우드·그린",       image: "assets/images/q2-woodgreen.jpg", scores: { MOD: 0, MIN: 0, NAT: 3, SCA: 1, CLA: 0, MCL: 0 } },
        { id: "Q2-4", label: "화이트·파스텔",   image: "assets/images/q2-pastel.jpg",   scores: { MOD: 0, MIN: 1, NAT: 1, SCA: 3, CLA: 0, MCL: 0 } },
        { id: "Q2-5", label: "딥브라운·골드",   image: "assets/images/q2-brown.jpg",    scores: { MOD: 0, MIN: 0, NAT: 0, SCA: 0, CLA: 3, MCL: 1 } },
        { id: "Q2-6", label: "뉴트럴+포인트",   image: "assets/images/q2-neutral.jpg",  scores: { MOD: 1, MIN: 1, NAT: 0, SCA: 0, CLA: 1, MCL: 3 } },
      ],
    },
       ...
       PRD 8-2: Q2와 동일 매핑 구조(해당 스타일 +3, 인접 +1). */
    {
      ...
      title: "끌리는 마감 소재는?",
      options: [
        { id: "Q4-1", label: "매끈한 무광·메탈",  image: "assets/images/q4-metal.jpg",   scores: { MOD: 3, MIN: 1, NAT: 0, SCA: 0, CLA: 0, MCL: 1 } },
        { id: "Q4-2", label: "대리석·세라믹",     image: "assets/images/q4-marble.jpg",  scores: { MOD: 1, MIN: 3, NAT: 1, SCA: 1, CLA: 0, MCL: 1 } },
        { id: "Q4-3", label: "원목·라탄",        image: "assets/images/q4-wood.jpg",    scores: { MOD: 0, MIN: 0, NAT: 3, SCA: 1, CLA: 0, MCL: 0 } },
        { id: "Q4-4", label: "밝은 우드·패브릭",  image: "assets/images/q4-fabric.jpg",  scores: { MOD: 0, MIN: 1, NAT: 1, SCA: 3, CLA: 0, MCL: 0 } },
        { id: "Q4-5", label: "몰딩·진한 우드",    image: "assets/images/q4-molding.jpg", scores: { MOD: 0, MIN: 0, NAT: 0, SCA: 0, CLA: 3, MCL: 1 } },
        { id: "Q4-6", label: "우드+간결한 디테일", image: "assets/images/q4-detail.jpg",  scores: { MOD: 1, MIN: 1, NAT: 0, SCA: 0, CLA: 1, MCL: 3 } },
      ],
    },
